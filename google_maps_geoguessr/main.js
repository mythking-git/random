...
function display_location(){
    ...
    document.getElementById("distance").innerHTML = "Distance away: " + accumulated_distance.toFixed(1) + " Miles";
    document.getElementById("totaldistance").innerHTML = "Round Score: " + 5000 * Math.exp(-0.5 * (accumulated_distance.toFixed(1) / 500)**2) + " Miles";
}
